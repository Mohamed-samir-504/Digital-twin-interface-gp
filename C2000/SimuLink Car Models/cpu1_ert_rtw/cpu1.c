...
const real32_T cpu1_R32GND = 0.0F;     /* real32_T ground */
...
void cpu1_step0(void)                  /* Sample time: [0.001s, 0.0s] */
{
  ...
  /* S-Function (c280xcanxmt): '<Root>/eCAN Transmit' */
  {
    ...
    CAN_sendMessage(CANA_BASE, 2, 8, (uint16_T*)ucTXMsgData);
  }
  ...
  vprev = (real32_T)(cpu1_B.sat * cpu1_B.ki);
  ...
  /* S-Function (c28xsci_tx): '<Root>/SCI Transmit4' */
  {
  ...
  cpu1_DW.Integrator_DSTATE_j += cpu1_P.Integrator_gainval_k * vprev;
...
void cpu1_initialize(void)
{
...

  {
    ...
    CAN_setupMessageObject(CANA_BASE, 2, 0x1C7, CAN_MSG_FRAME_STD,
